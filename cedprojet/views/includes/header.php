    ...
    <div class="container">
        <div class="row row1">
            <ul class="largenav pull-right">
                ...
                <li class="upper-links dropdown"><a class="links" href="<?=URL?>">Magasin</a>
                    ...
                    <ul class="dropdown-menu">
                      <?php if(empty($_SESSION['login']))
                      {
                        ...
                        if ($_SESSION['type'] == 1) {
                          ...
                          echo "<li class=\"profile-li\"><a class=\"profile-links\" href=\" "?><?=URL . "edit_article\">Editer article</a></li>";
                          echo "<li class=\"profile-li\"><a class=\"profile-links\" href=\" "?><?=URL . "user_edit\">Editer utilisateur</a></li>";
                        ...
                        echo "<li class=\"profile-li\"><a class=\"profile-links\" href=\" "?><?=URL . "user_profile\">Editer mon profil</a></li>";
        ...
        <div class="row row2">
            <div class="col-md-2">
                ...
                <!--<h2 style="margin:0px;"><span class="smallnav menu" onclick="openNav()">Goodies Geek</span></h2>
                <h1 style="margin:0px;"><span class="largenav">Goodies Geek</span></h1>-->
            </div>
